  ...
  return (
    <div className="w-full relative">
      <input
        ...
        ref={inputRef}
        autoComplete="off"
        className={`relative peer w-full outline-none px-2 pt-5 pb-3 border-b focus:placeholder-gray-500 disabled:bg-gray-100 text-gray-600 text-md font-normal leading-tight ${
          error
